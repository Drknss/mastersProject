...
public:
	...
	inline bool					IsRestStateEnabled()		const	{ return m_REnabled; }
	inline bool					InSpace()					const	{ return m_InSpace; }
	inline bool					Hit()						const	{ return m_Hit; }

	inline float				GetElasticity()				const 	{ return m_Elasticity; }
	inline float				GetFriction()				const 	{ return m_Friction; }
	inline int					GetGravityType()			const	{ return m_Gravity; }

	inline const Vector3&		GetMaxY()					const	{ return m_MaxY; }
	inline const Vector3&		GetMinY()					const	{ return m_MinY; }
	inline const Vector3&		GetMaxX()					const	{ return m_MaxX; }
	inline const Vector3&		GetMinX()					const	{ return m_MinX; }
	inline const Vector3&		GetMaxZ()					const	{ return m_MaxZ; }
	inline const Vector3&		GetMinZ()					const	{ return m_MinZ; }
	...
	inline double				GetLinearVelocityAvg()		const	{ return m_LinearVelocityAvg; }
	...
	inline double				GetAngularVelocityAvg()		const	{ return m_AngularVelocityAvg; }
	...
	//<--------- SETTERS ------------->
	inline void SetInSpace(bool inSpace)							{ m_InSpace = inSpace; }
	inline void SetAtRest(bool rest)								{ m_AtRest = rest; }
	inline void SetRestEnabled(bool rest)							{ m_REnabled = rest; }
	...
	inline void SetGravityType(int grav)							{ m_Gravity = grav; }

	inline void SetMaxY(const Vector3& v)							{ m_MaxY = v; }
	inline void SetMinY(const Vector3& v)							{ m_MinY = v; }
	inline void SetMaxX(const Vector3& v)							{ m_MaxX = v; }
	inline void SetMinX(const Vector3& v)							{ m_MinX = v; }
	inline void SetMaxZ(const Vector3& v)							{ m_MaxZ = v; }
	inline void SetMinZ(const Vector3& v)							{ m_MinZ = v; }
	...
	inline void SetLinearVelocityAvg(const double v)				{ m_LinearVelocityAvg = v; }
	...
	inline void SetAngularVelocityAvg(const double v)				{ m_AngularVelocityAvg = v; }
...
protected:
	...
	int					m_Gravity;			//Gravity Type

	//<---------LINEAR-------------->
	Vector3		m_Position;
	Vector3		m_LinearVelocity;
	Vector3		m_Force;
	double		m_LinearVelocityAvg = 100;
	float		m_InvMass;
	...
	Vector3		m_Torque;
	double		m_AngularVelocityAvg = 100;
