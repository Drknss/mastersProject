...
#define PROJ_FAR				600.0f			//Can see for 80m - setting this too far really hurts shadow quality as they attempt to cover the entirety of the view frustum
#define PROJ_NEAR				0.01f			//Nearest object @ 1cm
#define PROJ_FOV				90.0f			//45 degree field of view
...
public:
	...
	inline Camera* GetAIView()									{ return m_pAIViewPoint; }
